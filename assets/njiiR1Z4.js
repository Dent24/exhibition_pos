import{u as T,a as A}from"./C2dVcHEB.js";import{d as H,o as J,H as R,F as e,f as i,i as M,A as c,E as n,C as b,B,I as S,M as I,l as L,G as d,D as _,J as N,_ as O}from"./BsmMHUgW.js";const Q={class:"d-flex align-center"},W={class:"font-weight-bold mr-3"},K={class:"d-flex align-center justify-end"},U={class:"text-success font-weight-bold mr-3"},X={key:0,class:"pa-4 text-center text-grey"},Y=H({__name:"product-sales-report",setup(Z){const $=T(),z=A(),C=M(!1),P=M([]),D=async()=>{if(z.profile?.id){C.value=!0;try{const{data:f,error:r}=await $.from("Products").select(`
        id, 
        name,
