import{u as v,a as y}from"./DJmYv13N.js";import{O as b,o as w,i as a,m as q}from"./_2QnTdKM.js";const g=()=>{const c=v(),d=y(),p=a([]),s=a(null),n=a([]),i=a([]),r=a(!1),f=q(()=>i.value.reduce((t,e)=>t+e.event_price*e.quantity,0)),u=async()=>{if(!s.value){n.value=[];return}r.value=!0;try{const{data:t,error:e}=await c.from("Exhibition_Product_Details").select(`
          id, 
          event_price, 
          is_paid,
